...
import { openCourseForm, selectedCourse } from "../utils/courseCart.tsx";
    ...
    return (
        <div class="w-full">
            <input
                ...
                onFocusIn={() => searchFocus.value = true}
                ...
                <ul class="divide-y divide-red-500/12">
                    {
                        results.value.map((course) => (
                            <li 
                                ...
                                onMouseDown={(e) => {e.preventDefault(); openCourseForm.value = true; selectedCourse.value = course;}}
                            >
